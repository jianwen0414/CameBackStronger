...
try:
    ...
    from edge.reidentification import PersonReID
    REID_AVAILABLE = True
except ImportError:
    try:
        ...
        print("⚠️  Warning: tracker/reidentification not found")
...
class WeaponDetectorFast:
    ...
    def __init__(
        ...
        Args:
            ...
            distance_threshold: Max distance for weapon-person association
